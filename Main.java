...
public class Main {
 ...
 //           doCalculationTwo(createArray());
        ...
        private static void doCalculationOne(float[] arr) {
            ...
            System.out.println(Arrays.toString(arr));
            System.out.println("Общее время исполнения для 1 массива ");
            System.out.println(System.currentTimeMillis() - a);
        }

// вторая часть задания в 2 потока
...
//            System.out.println(Arrays.toString(arr));
//            System.out.println("Общее время исполнения для 2-ого массива ");
